...
public class Jugar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione al jugador rojo");

        jTextField2.setText("jTextField2");

        jTextPane3.setText("Seleccione al jugador azul");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().equals("")||jTextField2.getText().equals("")){
            ...
            if(listaAlias.contains(jTextField1.getText())&&listaAlias.contains(jTextField2.getText())){
